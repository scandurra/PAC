...
public class RestaurantWebController {
	...
	@GetMapping("/prefix/{restaurantName}")
	public ResponseEntity<Collection<Restaurant>> getRestaurants(@PathVariable String restaurantName) {
		log.debug("GET /prefix/" + restaurantName);
		Collection<Restaurant> restaurants = service.getAllRestaurantsByNameStartingChars(restaurantName);
